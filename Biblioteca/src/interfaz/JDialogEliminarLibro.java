...
public class JDialogEliminarLibro extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese ISBN del Libro a Eliminar");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(jTextField1.getText().isEmpty() ){
            ...
            int index = principal.buscarLibro(jTextField1.getText());
            if(index>=0){
                int confirma = JOptionPane.showConfirmDialog(this, "Confirmar");
                if(JOptionPane.OK_OPTION == confirma){
                    principal.listaLibro.remove(index);
                    JOptionPane.showMessageDialog(this,"Libro eliminado.");
                    this.setVisible(false);
                    principal.setVisible(true);
                    principal.actualizarDatosLibro();
                }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogEliminarLibro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
