...
public class JDialogTarjetaDocente extends javax.swing.JDialog {
        private JFramePrestamoDocente doc = (JFramePrestamoDocente) this.getParent();
            private String rut;
            private String ISBN;
    

    public JDialogTarjetaDocente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        public JDialogTarjetaDocente(java.awt.Frame parent, boolean modal,String rut,String ISBN) {
        super(parent, modal);
        initComponents();
        this.setTitle("Biblioteca - Universidad Andrés Bello");
        this.setLocationRelativeTo(null);
        ...
        public void cargarDatos(){
            ...
            System.out.println(doc.getFip().listaDocente);
            
            
            
        Docente b = doc.getFip().listaDocente.get(doc.getFip().buscarDocente(this.rut));  
        
        textUsuario.setText(b.getNombre());
        
        textRut.setText(b.getRut());
        
        Libro l = doc.getFip().listaLibro.get(doc.getFip().buscarLibro(this.ISBN));
        ...
        textFechaDevolucion.setText(fechaDevolucionDoc());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogTarjetaDocente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogTarjetaDocente dialog = new JDialogTarjetaDocente(new javax.swing.JFrame(), true);
