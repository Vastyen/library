...
public class JDialogEliminarEstudiante extends javax.swing.JDialog {
    private JFrameInterfazPrincipal principal = (JFrameInterfazPrincipal)this.getParent();

    public JDialogEliminarEstudiante(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        if(jTextField1.getText().isEmpty()  ){
            ...
            if(index>=0){
                ...
                if(JOptionPane.OK_OPTION == confirma){
                    principal.listaEstudiante.remove(index);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogEliminarEstudiante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogEliminarEstudiante dialog = new JDialogEliminarEstudiante(new javax.swing.JFrame(), true);
